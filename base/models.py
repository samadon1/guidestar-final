...
class Reviews(models.Model):
    ...
    user_type = models.TextField(max_length=20,choices = USER_TYPE, default='Donor')
...
class ClaimProfile(models.Model):
    ...
    connection = models.TextField(verbose_name="How are you connected to the organization?", max_length=20, choices = CONNECTIONS, default='Staff')
