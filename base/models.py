...
class Reviews(models.Model):
    ...
    user_type = models.TextField(choices = USER_TYPE, default='Donor')
...
class ClaimProfile(models.Model):
    ...
    connection = models.CharField(verbose_name="How are you connected to the organization?", choices = CONNECTIONS, default='Staff')
